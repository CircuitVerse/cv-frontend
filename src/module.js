...
// class Multiplexer extends CircuitElement {
//     constructor(
//         x,
//         y,
//         scope = globalScope,
...
// class XorGate extends CircuitElement {
...
// class XnorGate extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", inputs = 2, bitWidth = 1) {
//         super(x, y, scope, dir, bitWidth);
//         this.rectangleObject = false;
//         this.setDimensions(15, 20);
...
// class SevenSegDisplay extends CircuitElement {
...
// class SixteenSegDisplay extends CircuitElement {
//     constructor(x, y, scope = globalScope) {
...
// class HexDisplay extends CircuitElement {
//     constructor(x, y, scope = globalScope) {
...
// class OrGate extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", inputs = 2, bitWidth = 1) {
...
// class Stepper extends CircuitElement {
...
// class NotGate extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
...
// class ForceGate extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
...
// class Text extends CircuitElement {
//     constructor(x, y, scope = globalScope, label = "") {
...
// class TriState extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
//         super(x, y, scope, dir, bitWidth);
//         this.rectangleObject = false;
//         this.setDimensions(15, 15);
...
// class Buffer extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
//         super(x, y, scope, dir, bitWidth);
//         this.rectangleObject = false;
//         this.setDimensions(15, 15);
...
// class ControlledInverter extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
//         super(x, y, scope, dir, bitWidth);
//         this.rectangleObject = false;
//         this.setDimensions(15, 15);
...
// class Adder extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
...
// class Rom extends CircuitElement {
//     constructor(
//         x,
//         y,
//         scope = globalScope,
...
// class Splitter extends CircuitElement {
//     constructor(
//         x,
//         y,
//         scope = globalScope,
...
// class Power extends CircuitElement {
//     constructor(x, y, scope = globalScope, bitWidth = 1) {
...
// class Input extends CircuitElement {
...
// class Output extends CircuitElement {
...
// class BitSelector extends CircuitElement {
//     constructor(
//         x,
//         y,
//         scope = globalScope,
...
// class ConstantVal extends CircuitElement {
...
// class NorGate extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", inputs = 2, bitWidth = 1) {
...
// class DigitalLed extends CircuitElement {
...
// class VariableLed extends CircuitElement {
//     constructor(x, y, scope = globalScope) {
//         // Calling base class constructor
...
// class Button extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT") {
...
// class RGBLed extends CircuitElement {
//     constructor(x, y, scope = globalScope) {
//         // Calling base class constructor
...
// class SquareRGBLed extends CircuitElement {
...
// class Demultiplexer extends CircuitElement {
//     constructor(
//         x,
//         y,
//         scope = globalScope,
...
// class Decoder extends CircuitElement {
...
// class Flag extends CircuitElement {
...
// class MSB extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
...
// class LSB extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
...
// class PriorityEncoder extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
...
// class Tunnel extends CircuitElement {
...
// class ALU extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT", bitWidth = 1) {
//         // //console.log("HIT");
//         // //console.log(x,y,scope,dir,bitWidth,controlSignalSize);
//         super(x, y, scope, dir, bitWidth);
...
// class Rectangle extends CircuitElement {
...
// class Arrow extends CircuitElement {
//     constructor(x, y, scope = globalScope, dir = "RIGHT") {
